...
\begin{frame}{Literature}{Can the Treasury kill the basis trade? Steven Kelly, Without Warning, February 2024}
  \textbf{The trade}
  \begin{itemize}
    \item Funds are long the cash Treasury and short the rich futures contract with asset managers on the other side, positions approach 800 billion dollars and exceed the pre pandemic peak.
    \item TBAC puts the carry near 45 basis points a year, above 900 basis points at twenty times leverage, and a Fed note estimates average repo leverage at 56 times.
    \item March 2020 showed the fragility, when the basis diverged margin calls forced fire sales into the dash for cash.
  \end{itemize}
  \medskip
  \textbf{The argument}
  \begin{itemize}
    \item Repo funding of the trade reveals structural demand for short term money assets, which funds manufacture out of long term Treasuries.
    \item The Treasury could capture that demand directly by issuing more bills and crowd out the trade without any crackdown.
    \item Asset managers would adjust on their own since more bills shorten the benchmark index and their demand for long futures falls.
  \end{itemize}
  \medskip
  \takeaway{The trade is repo funded maturity transformation, so funding conditions and issuance policy set its size, exactly the margins our funding architecture and fragility sections examine.}
\end{frame}
