...
\begin{frame}{Anatomy of the trade}{Takeaway}
  \centering
  \begin{minipage}{.8\textwidth}
    \centering\large
    Funds are paid to hold what curve sensitive investors and dealers do not want, providing liquidity and convergence in the illiquid segment.
  \end{minipage}
\end{frame}
...
\begin{frame}{Fragility through the dealer funding channel}
  ...
  \end{itemize}
  \medskip
  \textbf{Test}\quad{\small\color{slate} the Khwaja and Mian design adapted from credit registers to repo}
  \begin{itemize}
