...
\begin{frame}{Anatomy of the trade}{Positions are concentrated in a handful of funds}
  ...
  {\small\color{slate} Each day the five largest funds are ranked by the absolute value of their net repo position, the chart shows their share in the total across all funds trading directly, on average roughly a third}
\end{frame}
