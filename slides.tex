...
\begin{frame}{Fragility through the volatility shock}{Cross market transmission}
  \textbf{Hypothesis}
  \begin{itemize}
  ...
  \textbf{Test}
  \begin{itemize}
    \item Treatment intensity is the fund's ex ante UST exposure.
    \item Did exposed funds cut their European positions more than other funds in the same bond and week, with bond$\times$time fixed effects?
  \end{itemize}
  \medskip
...
\begin{frame}{Fragility through the volatility shock}{The spillover result}
  \textbf{Hypothesis}
  \begin{itemize}
    \item Fund selling matters for markets only if it aggregates, the step from funds sold to prices moved.
  \end{itemize}
  \medskip
  \textbf{Test}
  \begin{itemize}
    \item Bond level cross section where treatment is the bond's pre shock exposure to affected funds.
