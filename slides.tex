...
\begin{frame}{Literature}{Can the Treasury kill the basis trade? Steven Kelly, Blog post, February 2024}
  ...
  \medskip
  \textbf{The trade unbundles the long term bond for two investor groups that each want only one piece of it.}
  \begin{itemize}
    ...
    \item Asset managers want long duration without funding bond purchases. They keep their cash in credit and close the duration gap to their Treasury heavy benchmark with long futures.
    \item Hedge funds buy the bond and split it. The repo leg passes its moneyness to the money market funds, the futures leg passes its duration to the asset managers, and the basis is the fee for intermediating.
  \end{itemize}
  \smallskip
  \textbf{More bills unwind both legs at once.}
  \begin{itemize}
    \item Bills serve the money demand directly, so cash migrates from repo to bills and the funding and carry of the trade dry up.
