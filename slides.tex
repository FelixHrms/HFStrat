...
\begin{frame}{Literature}{Can the Treasury kill the basis trade? Steven Kelly, Without Warning, February 2024}
  \footnotesize
  \keypoint{Tilting issuance toward bills would serve the money demand that currently funds the basis trade and crowd the trade out, no regulatory crackdown needed.}
  \medskip
  \begin{itemize}
    \item The trade is repo funded and repo cash would rather hold bills, so basis traders are effectively manufacturing money like assets out of long term bonds.
    \item More bills serve that money demand directly, so the repo funding of the trade and the carry it harvests dry up.
    \item The futures side adjusts on its own. Asset managers hold long futures only to close the duration gap to Treasury heavy benchmarks, and a bill heavier index shrinks that gap and the futures demand with it.
    \item The cost to the Treasury is small. Rollover risk is limited for the safest issuer, bills already absorb crisis issuance, and the loss of occasional negative term premium episodes buys less blowup risk.
    \item Issuance composition already moves in practice, the Treasury termed out only while the Fed ran QE and the trade grew as QE unwound.
  \end{itemize}
\end{frame}
