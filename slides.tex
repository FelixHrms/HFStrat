...
\begin{frame}{Anatomy of the trade}{Three dealers finance more than half of the trade}
  ...
  % The underlying numbers exist in descriptives_prep.ipynb (cells sorting
  % counterparties by volume with cumulative shares, top three are primary
  % dealers with 88 percent of USD activity) but no chart is exported yet.
  % Figures/distribution_HF_counterparties.png shows counterparties per fund
  % instead and fits the funding architecture section.
\end{frame}
